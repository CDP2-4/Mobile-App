 ...
 * */
public class HttpClass_bak extends Thread {
	...
	public HttpClass_bak(Context _context, int _order, Handler _handler, HashMap<String, String> _params){
		mOrder = _order;
		mHandler = _handler;
		mParams_map = _params;
		mContext = _context;
	...
	public HttpClass_bak(Context _context, int _order, Handler _handler, ArrayList<String> _fileList, HashMap<String, String> _params){
		mContext = _context;
		mOrder = _order;
		mHandler = _handler;
		mParams_map = _params;
